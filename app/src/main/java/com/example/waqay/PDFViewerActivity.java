...
//PDFView pdfView;
    ...
    PagerAdapter adapter;TabLayout tabLayout;
    @Override
...
//     remotePDFViewPager.autofill(AutofillValue.forText("ma"));
    ...
    public void onFailure(Exception e) {
        Toast.makeText(PDFViewerActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show(); progressBar.setVisibility(View.GONE);
    }
